          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden lg:flex items-center gap-8">
              ...
              >
                <Link
                  to="/products"
                  className="flex items-center gap-1 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-accent-600 dark:hover:text-accent-400 transition-colors"
                >
                  Products
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/about" className="text-sm hover:text-accent-400 transition-colors">About Us</Link></li>
                <li><Link to="/fees" className="text-sm hover:text-accent-400 transition-colors">Fees</Link></li>
                <li><Link to="/contact" className="text-sm hover:text-accent-400 transition-colors">Contact Us</Link></li>
                <li><Link to="/careers" className="text-sm hover:text-accent-400 transition-colors">Careers</Link></li>
                <li><Link to="/blog" className="text-sm hover:text-accent-400 transition-colors">Blog</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/delete-account" className="text-sm hover:text-accent-400 transition-colors">Delete Account</Link></li>
