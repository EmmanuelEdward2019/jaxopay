/**
 * Full ISO 3166-1 country list (code + name) — for admin-facing pickers that must accept ANY
 * country, unlike the narrower SMILE_ISO2_COUNTRIES list (smileKycOptions.js) which is scoped to
 * what Smile ID's KYC product actually supports. Used by UserManagement.jsx's Add User modal:
 * the admin manually verifies the person's ID before adding them, so the app has no business
 * restricting which country they can be recorded under.
 */
