...
function sanitizeDashboardErrorMessage(input) {
  ...
  const pairs = [
    ...
    [/VTPASS_[A-Z0-9_]*/gi, 'server configuration'],
    [/VTpass/gi, 'Bill payment service'],
    [/QUIDAX_[A-Z0-9_]*/gi, 'server configuration'],
    [/openapi\.quidax\.io|app\.quidax\.io|quidax\.com/gi, 'exchange service'],
    [/Quidax/gi, 'Exchange service'],
    [/api\.korapay\.com|korapay\.com/gi, 'payment service'],
    [/Korapay/gi, 'Payment service'],
    [/Reloadly/gi, 'Gift card service'],
    [/MEXC/gi, 'Exchange service'],
    [/Sumsub/gi, 'Identity verification'],
