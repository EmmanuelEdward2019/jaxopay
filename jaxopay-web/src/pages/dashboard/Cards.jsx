                                ...
                                <div className="flex items-start justify-between mb-8">
                                    ...
                                    <div className="flex items-center gap-2">
                                        {card.card_status === 'frozen' && (
                                            <span className="px-2 py-1 bg-blue-500/30 text-blue-100 text-xs font-medium rounded-full flex items-center gap-1">
            ...
            >
                ...
                <div className="mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        >
                            <CreditCard className={`w-8 h-8 mb-2 ${cardType === 'single_use' ? 'text-primary-600' : 'text-gray-400'}`} />
